    ...
    public class ServiceHealth : IServiceHealth, IServiceHealthAlert
    {
        ...
        public bool InsertOxygenSaturationRecord(OxygenSaturation saturation)
        {
            using (ModelMyHealthContainer context = new ModelMyHealthContainer())
            {
                try
                {
                    ...
                    Alerta al = context.AlertaSet.FirstOrDefault(i => i.TipoAlertas.Nome.Equals("SPO2"));
        ...
        public bool InsertBloodPressureRecord(BloodPressure bloodPressure)
        {
            using (ModelMyHealthContainer context = new ModelMyHealthContainer())
            {
                try
                {
                    ...
                    Alerta al = context.AlertaSet.FirstOrDefault(i => i.TipoAlertas.Nome.Equals("BP"));
        ...
        public bool InsertHeartRateRecord(HeartRate heartRate)
        {
            using (ModelMyHealthContainer context = new ModelMyHealthContainer())
            {
                try
                {
                    ...
                    Alerta al = context.AlertaSet.FirstOrDefault(i => i.TipoAlertas.Nome.Equals("HR"));
        ...
        public List<HeartRate> HeartRateList(int sns)
        {
            using (ModelMyHealthContainer context = new ModelMyHealthContainer())
            {
                try
                {
                    ...
                    var frequencias = context.FrequenciaCardiacaValoresSet.Where(i => i.Utente.SNS == sns);
        ...
        public List<OxygenSaturation> OxygenSaturationList(int sns)
        {
            using (ModelMyHealthContainer context = new ModelMyHealthContainer())
            {
                try
                {
                    ...
                    var saturacoes = context.SaturacaoValoresSet.Where(i => i.Utente.SNS == sns);
        ...
        public List<BloodPressure> BloodPressureList(int sns)
        {
            using (ModelMyHealthContainer context = new ModelMyHealthContainer())
            {
                try
                {
                    ...
                    var pressoes = context.PressaoSanguineaValoresSet.Where(i => i.Utente.SNS == sns);
        ...
        public Alert GetAlert(string type)
        {
            using (ModelMyHealthContainer context = new ModelMyHealthContainer())
            {
                try
                {
                    Alerta alerta = context.AlertaSet.FirstOrDefault(i => i.TipoAlertas.Nome.Equals(type));

                    Alert alert = new Alert();
                    alert.Type = alerta.TipoAlertas.Nome;
        ...
        public bool UpdateAlert(Alert _alert)
        {
            using (ModelMyHealthContainer context = new ModelMyHealthContainer())
            {
                try
                {
                    ...
                    Alerta alerta = context.AlertaSet.FirstOrDefault(i => i.TipoAlertas.Nome.Equals(_alert.Type));
        ...
        public List<Alert> GetAlertList()
        {
            using (ModelMyHealthContainer context = new ModelMyHealthContainer())
            {
                try
                {
                    ...
                    {
                        Alert alert = new Alert();
                        alert.Type = al.TipoAlertas.Nome;
